<template>
    <div>
        <div style = "height:30px; width:100%; margin-top:20px;">
                <VueSubLayoutCard lab="pub-sub-2022-assocaiate"></VueSubLayoutCard>
        </div>
...
## Event-Driven 과 Request/Response 방식 비교
        ...
        <g-image src="~/img/03_Bizdevops/04_통합/03_Event-driven 기반 통합/image1.png"></g-image>
        <mark-down class="content">
...
## Event Publish / Subscribe (PubSub) 내부 통신 방법
        ...
        <g-image src="~/img/03_Bizdevops/04_통합/03_Event-driven 기반 통합/image2.png"></g-image>
        <mark-down class="content">
...
#### Adding a new service
        ...
        <g-image src="~/img/03_Bizdevops/04_통합/03_Event-driven 기반 통합/image3.png"></g-image>
        <mark-down class="content">
