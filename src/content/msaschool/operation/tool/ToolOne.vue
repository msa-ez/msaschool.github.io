...
EventStorming2Code 도구의 전체 화면 레이아웃은 다음과 같습니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image1.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름               | 기능 설명                                           |
| -- | ---------------- | ----------------------------------------------- |
...
스티커 팔레트에서 주황색 아이콘을 캔버스로 Drag & Drop하여 Event를 추가합니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image2.png"></g-image><br>
        
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image3.png"></g-image><br>
        <mark-down class="content">
### **\[Event 속성 설정\]**
...
추가된 Event 스티커를 더블 클릭하게 되면, 오른쪽에 아래와 같이 속성 창이 나타나며, 각 속성 설정에 대한 값은 아래와 같습니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image4.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름                   | 기능 설명                     |
| -- | -------------------- | ------------------------- |
...
스티커 팔레트에서 라일락색 아이콘을 캔버스로 Drag & Drop하여 Policy를 추가합니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image5.png"></g-image><br>
        
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image6.png"></g-image><br>
        <mark-down class="content">
###  **\[Policy 속성 설정\]**
...
추가된 Policy 스티커를 더블 클릭하게 되면, 오른쪽에 아래와 같이 속성 창이 나타나며, 각 속성 설정에 대한 값은 아래와 같습니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image7.png"></g-image><br>
        <mark-down class="content">
...
스티커 팔레트에서 파란색 아이콘을 캔버스로 Drag & Drop하여 Command를 추가합니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image8.png"></g-image><br>
        
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image9.png"></g-image><br>
        <mark-down class="content">
### **\[Command 속성 설정\]**
...
추가된 Command 스티커를 더블 클릭하게 되면, 오른쪽에 아래와 같이 속성 창이 나타나며, 각 속성 설정에 대한 값은 아래와 같습니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image10.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름                   | 기능 설명                       |
| -- | -------------------- | --------------------------- |
...
스티커 팔레트에서 노란색 아이콘을 캔버스로 Drag & Drop하여 Aggregate를 추가합니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image11.png"></g-image><br>
        
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image12.png"></g-image><br>
        <mark-down class="content">
### **\[어그리게잇 속성 설정\]**
...
추가된 Aggregate 스티커를 더블 클릭하게 되면, 오른쪽에 아래와 같이 속성 창이 나타나며, 각 속성 설정에 대한 값은 아래와 같습니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image13.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름             | 기능 설명                                   |
| -- | -------------- | --------------------------------------- |
...
스티커 팔레트에서 점선 모양의 아이콘을 캔버스로 Drag & Drop하여 Bounded Context를 추가합니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image14.png"></g-image><br>
        
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image15.png"></g-image><br>
        <mark-down class="content">
### **\[Bounded Context 속성 설정\]**

 </mark-down>
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image16.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름                   | 기능 설명                   |
| -- | -------------------- | ----------------------- |
...
Event 스티커에서 화살표 모양 아이콘을 선택, 또는 Drag 하여 연결될 Policy 스티커를 선택 또는 Drop하면 연결됩니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image17.png"></g-image><br>
        
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image18.png"></g-image><br>
        <mark-down class="content">
### **\[Relation 속성 설정\]**

 </mark-down>
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image19.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름           | 기능 설명                                                                                     |
| -- | ------------ | ----------------------------------------------------------------------------------------- |
...
위의 이벤트 스토밍이 완료되면 아래 그림과 같이 나옵니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image20.png"></g-image><br>
        <mark-down class="content">
## **코드 프리뷰**
...
### **\[코드 프리뷰 레이아웃\]**
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image21.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름              | 기능 설명                                                  |
| -- | --------------- | ------------------------------------------------------ |
...
Download Archive를 선택하면 Template을 선택할 수 있으며, EventStroming 된 결과를 Zip파일로 다운로드 받을 수 있습니다.
        ...
        <g-image src="~/img/04_Library/02_MSA도구 - MSAEasy/01_MSAEasy 사용법/image22.png"></g-image><br>
        <mark-down class="content">
| 번호 | 이름              | 기능 설명                                                  |
| -- | --------------- | ------------------------------------------------------ |
