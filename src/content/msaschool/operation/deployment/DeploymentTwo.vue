...
- 테스트 실행은 10분이 상한선입니다. <a href='https://services.google.com/fh/files/misc/state-of-devops-2018.pdf?hl=ko#page=56' target='_blank'>DORA's research</a>
...
## 파이프라인 샘플
        ...
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image1.png"></g-image>
...
1. GCP 에 가입을 하여 Kubernetes 클러스터를 생성 합니다.
        ...
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image2.png"></g-image>
...
3. 예제 소스인 <a href='https://github.com/event-storming/reqres_orders' target='_blank'>reqres_orders</a> 을 fork 합니다.
        ">
        </mark-down>
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image3.png"></g-image>

        <mark-down class="content">
4. GCB 에서 트리거를 생성 합니다.
        </mark-down>
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image4.png"></g-image>


        <mark-down class="content">
5. 트리거할 gitgub 소스를 선택 하고, 빌드 구성 방식을 Cloud Build 로 선택합니다.
        </mark-down>
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image5.png"></g-image>
...
7. 트리거된 파이프라인은 cloudbuild.yaml 파일에 있는 CI/CD 프로세스를 실행 하고 빌드,배포 과정을 모니터링 해줍니다.
        ...
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image6.png"></g-image>
        <g-image src="~/img/03_Bizdevops/05_배포/02_파이프라인(Pipeline)/image7.png"></g-image>
...
> 전체 소스 : <a href='https://github.com/event-storming/reqres_orders/blob/master/cloudbuild.yaml' target='_blank'>cloudbuild.yaml</a>
> GCB 설정 : <a href='https://cloud.google.com/cloud-build/docs' target='_blank'>GCB 설정</a>
...
<a href='https://cloud.google.com/sdk/gcloud' target='_blank'>gcr.io/cloud-builders/gcloud</a>이미지를 사용하면 gcloud 명령어를 사용할 수있습니다.
