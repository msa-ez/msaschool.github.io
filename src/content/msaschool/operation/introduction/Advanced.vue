        ...
        <div>
            ...
            <table class="tbl-edu" style="width:100%;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    ...
                    <td style="border-left: 1px solid #aaa; font-weight:700;">도메인 주도 SW설계의<br>확장</td>
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    ...
                    <td style="border-left: 1px solid #aaa; font-weight:700;">마이크로서비스의<br>분석/설계 심화</td>
                    <td style="border-left: 1px solid #aaa;">
            ...
            <table class="tbl-edu" style="width:100%;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    <td style="text-align: center;">오전<br>9:00~11:30</td>
                    <td style="border-left: 1px solid #aaa; font-weight:700;">구현: 마이크로 서비스<br>트랜잭션과 데드라인</td>
                    <td style="border-left: 1px solid #aaa;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    ...
                    <td style="border-left: 1px solid #aaa; font-weight:700;">EDA에 최적화된<br>MSA Chassis</td>
                    <td style="border-left: 1px solid #aaa;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    <td style="border-left: 1px solid #aaa; font-weight:700;">인터-마이크로서비스 통신 : gRPC, Spring Reactor</td>
                    <td style="border-left: 1px solid #aaa;">
            ...
            <table class="tbl-edu" style="width:100%;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    <td style="text-align: center;">오전<br>9:00~11:30</td>
                    <td style="border-left: 1px solid #aaa; font-weight:700;">Kafka CDC와<br>마이크로서비스 보안</td>
                    <td style="border-left: 1px solid #aaa;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    <td style="text-align: center;">오후<br>13:00~17:30</td>
                    <td style="border-left: 1px solid #aaa; font-weight:700;">운영: Service Mesh deep dive</td>
                    <td style="border-left: 1px solid #aaa;">
            ...
            <table class="tbl-edu" style="width:100%;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    <td style="text-align: center;">오전<br>9:00~11:30</td>
                    <td style="border-left: 1px solid #aaa; font-weight:700;">GitOps</td>
                    <td style="border-left: 1px solid #aaa;">
                ...
                <tr style="border-bottom: 1px solid #aaa;">
                    <td rowspan="2" style="text-align: center;">오후<br>13:00~17:30</td>
                    <td style="border-left: 1px solid #aaa; font-weight:700;">Serverless</td>
                    <td style="border-left: 1px solid #aaa;">
