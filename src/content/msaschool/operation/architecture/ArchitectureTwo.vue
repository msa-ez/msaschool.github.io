...
API Management가 마이크로서비스 구성 요소 그룹의 외부 경계에서 보호하고 제어하는 역할을 수행하는 것과 달리, Service Mesh는 아래 그림에서와 같이 경계 내부에서 역할을 수행합니다.
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image1.png"></g-image><br>
        <mark-down class="content">
...
### **API Management, Service Mesh 비교**
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image2.png"></g-image><br>
        <mark-down class="content">
...
API Management 는 일반적으로 Gateway 프록시 패턴을 사용해서 수행됩니다.
...
이에 반해 Service Mesh는 일반적으로 Side Car Proxy 패턴을 사용합니다. Gateway가 없으며, 호출자는 Mesh내에서 존재합니다.
...
**1. Library**
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image3.png"></g-image><br>
        <mark-down class="content">
...
**2. Node Agent (Shared host Proxy)**
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image4.png"></g-image><br>
        <mark-down class="content">
...
**3. Sidecar (Recommended)**
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image5.png"></g-image><br>
        <mark-down class="content">
...
**Service Mesh 미 구성 아키텍처**
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image8.png"></g-image><br>
        <mark-down class="content">
...
**Service Mesh 적용 아키텍처**
        ...
        <g-image src="~/img/04_Library/04_MSA Outer 아키텍처/02_Service Mesh/image9.png"></g-image><br>
        <mark-down class="content">
