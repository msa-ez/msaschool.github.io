...
- fork 는 외부의 프로젝트를 자신의 레파지토리로 옮기는 작업입니다. 외부 프로젝트는 소스 수정이 안되지만, 자신의 레파지토리는 수정이 가능합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image1.png"></g-image>
        <br/>
        <mark-down class="content">
2. GCB 에서 트리거를 생성 합니다.
        </mark-down>
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image2.png"></g-image>
        <br/>
        <mark-down class="content">
...
수정하여 줍니다. 사용중지를 사용 설정으로 변경합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image3.png"></g-image>
        <br/>
        <mark-down class="content">
3. 트리거할 gitgub 소스를 선택 하고, 빌드 구성 방식을 Cloud Build 로 선택합니다.
        </mark-down>
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image4.png"></g-image>
        <br/>
        <mark-down class="content">
...
5. 트리거된 파이프라인은 cloudbuild.yaml 파일에 있는 CI/CD 프로세스를 실행 하고 빌드,배포 과정을 모니터링 해줍니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image5.png"></g-image>
        <br/>
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image6.png"></g-image>
        <br/>
        <mark-down class="content">
...
- 리스트 중 ui의 엔드포인트 클릭하여 쇼핑몰 화면에 접속 합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image7.png"></g-image>
        <br/>
        <mark-down class="content">
## 무정지 버전업 Github 에서 코드를 변경시에 클라우드에 무정지로 반영이 됩니다.
...
- Github 에서 파일을 클릭하고 우측의 연필 모양을 클릭하면 소스코드를 수정 할 수 있습니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image8.png"></g-image>
        <br/>
        <mark-down class="content">
2. 해당 파일을 수정하고 Commit changes 버튼을 클릭합니다.
    ...
    - 그 후 소스코드를 반영하는 Commit changes 버튼을 클릭하여 소스코드를 반영합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image9.png"></g-image>
        <br/>
        <mark-down class="content">
...
상단의 바가 색이 변하는 것을 확인 할 수 있습니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image10.png"></g-image>
        <br/>
        <mark-down class="content">
## 쇼핑몰 배포
...
- My Page(UI Mashup) 로 되어있는 화면을 클릭하여 주문 내역을 확인합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image11.png"></g-image>
        <br/>
        <mark-down class="content">
## 간섭없는 서비스 추가
...
합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image12.png"></g-image>
        <br/>
        <mark-down class="content">
...
4. 배포 완료 후 My Page(CQRS) 메뉴를 보면 데이터가 생성되어 있습니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image13.png"></g-image>
        <br/>
        <mark-down class="content">
...
1. 장애 상황을 만들기 위하여 배송 서비스를 중지 합니다.
    - GCP 의 쿠버네티스 엔진에서 작업 부하 메뉴에 들어갑니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image14.png"></g-image>
        <br/>
        <mark-down class="content">
...
- 작업 부하 화면에서 delivery 가 0으로 변경된 것을 확인 합니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image15.png"></g-image>
        <br/>
        <mark-down class="content">
...
- My Page(CQRS) 메뉴는 배송 상태가 '배송준비중' 으로 보여집니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image16.png"></g-image>
        <br/>
        <mark-down class="content">
- My Page(UI Mashup) 메뉴 에서는 배송 상태가 아예 안보입니다. 이는 UI 에서 각 서비스의 api 를 호출하여 데이터를 조회한 후에 UI 에서 Mashup 을 하는 구조이기 때문입니다.
        </mark-down>
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image17.png"></g-image>
        <br/>
        <mark-down class="content">
...
- 기존의 '배송 준비중' 상태가 '배송 완료' 로 변경 되는 것을 확인 할 수 있습니다.
        ...
        <br />
        <g-image src="~/img/01_Introduction/04_예제_애플리케이션_둘러보기/image18.png"></g-image>
        <br />
    </div>
</template>
